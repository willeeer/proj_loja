...
$filename        = date('d').''.date('m').''.date('Y').'.REM';  // nome do seu arquivo de remessa a ser gerado
...
$registro_t1 .= picture_x('39',2);										// 157 a 158 -> Instrucao 1 do boleto 39 não receber apos o vencimento
$registro_t1 .= picture_x('70',2);										// 159 a 160 -> Instrucao 2 do boleto 70 uso do banco
$registro_t1 .= picture_9($valor_multa,13);								// 161 a 173 -> valor da multa
$registro_t1 .= picture_9($data_desconto,6);							// 174 a 179 -> data para desconto
...
$registro_t1 .= complementoRegistro(6,"brancos");						// 386 a 391 -> data de mora
$registro_t1 .= complementoRegistro(2,"brancos");						// 392 a 393 -> prazo
